...
// Registers all plugins in the registry for a window created by the
// desktop_multi_window plugin. Without this, secondary windows (diagnostic log
// window, floating install window) would run without their platform plugins.
...
static void my_application_activate(GApplication* application) {
  ...
  gtk_window_set_title(window, "Wristload");
